    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
          ...
          <div className="order-1 md:order-1 animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <BlurText
              text="Santri dan Mahasiswa Pendidikan Agama Islam (PAI) yang antusias dengan pengembangan pendidikan, kajian keislaman, dan integrasi teknologi."
              delay={150}
              animateBy="words"
              direction="top"
              className=" mb-6"
          ...
          {/* KOLOM KANAN: Card */}
          <div className="order-2 md:order-2 md:ml-auto animate__animated animate__fadeInUp animate__delay-4s">
            <ProfileCard
              name="Ahmad Hirzi AA"
              title="Mahasiswa PAI"
              handle="ahmadhirziaa"
              ...
              onContactClick={() => window.open('https://wa.me/6285804031268', '_blank')}
            />
          </div>
        </div>
        {/* tentang */}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-0 px-8" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            ...
            <div className="order-1 md:order-2 basis-full md:basis-7/12 pl-0 md:pl-8 border-b md:border-b-0 border-violet-500/30">
              <div className="flex-1 text-left">
                ...
                <BlurText
                  text="Mahasiswa Program Studi Pendidikan Agama Islam yang memiliki minat pada pengembangan pendidikan, kajian keislaman, serta pemanfaatan teknologi untuk mendukung aktivitas akademik. Fokus utama saya adalah penguatan literasi ilmiah dan integrasi teknologi digital dalam kebutuhan belajar mahasiswa."
                  delay={150}
                  animateBy="words"
                  direction="top"
                ...
                <div className="flex flex-col sm:flex-row items-center sm:justify-start gap-x-12 gap-y-8 sm:gap-y-0 mb-4 w-full text-center sm:text-left">
                  <div>
                  ...
                  <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600" data-aos-once="true">
                    <h1 className="text-3xl md:text-4xl mb-1">
                      3.80<span className="text-violet-500">/4.00</span>
                    </h1>
                    <p>GPA</p>
                  </div>
                </div>
          ...
          <div className="tools-box mt-14 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
            ...
            {listTools.map((tool) => (
              <div
                ...
                className="flex items-center gap-4 p-4 border border-zinc-700 rounded-full bg-zinc-900/60 backdrop-blur-md hover:bg-zinc-800/80 transition-all duration-300 group shadow-[0_0_15px_rgba(168,85,247,0.15)] hover:shadow-[0_0_25px_rgba(168,85,247,0.3)] hover:-translate-y-1"
              >
                <img
                  src={tool.gambar}
                  alt="Tools Image"
                  className="w-16 h-16 object-contain bg-zinc-800 p-2 rounded-full group-hover:bg-zinc-900 transition-all duration-300 shadow-inner"
                />
